...
public class Feature_data implements org.apache.thrift.TBase<Feature_data, Feature_data._Fields>, java.io.Serializable, Cloneable, Comparable<Feature_data> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("Feature_data");
  ...
  private static final org.apache.thrift.protocol.TField FEATURE_NOTES_FIELD_DESC = new org.apache.thrift.protocol.TField("feature_notes", org.apache.thrift.protocol.TType.STRING, (short)12);
  ...
  static {
    schemes.put(StandardScheme.class, new Feature_dataStandardSchemeFactory());
    schemes.put(TupleScheme.class, new Feature_dataTupleSchemeFactory());
  }
  ...
  public String feature_notes; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(Feature_data.class, metaDataMap);
  }
   ...
   */
  public Feature_data(Feature_data other) {
    ...
    if (other.isSetFeature_notes()) {
      this.feature_notes = other.feature_notes;
    }
  ...
  public Feature_data deepCopy() {
    return new Feature_data(this);
  }
  ...
  public Feature_data setFeature_id(String feature_id) {
    this.feature_id = feature_id;
    return this;
  }
  ...
  public Feature_data setFeature_type(String feature_type) {
    this.feature_type = feature_type;
    return this;
  }
  ...
  public Feature_data setFeature_function(String feature_function) {
    this.feature_function = feature_function;
    return this;
  }
  ...
  public Feature_data setFeature_aliases(Map<String,List<String>> feature_aliases) {
    this.feature_aliases = feature_aliases;
    return this;
  }
  ...
  public Feature_data setFeature_dna_sequence_length(long feature_dna_sequence_length) {
    this.feature_dna_sequence_length = feature_dna_sequence_length;
    setFeature_dna_sequence_lengthIsSet(true);
    return this;
  }
  ...
  public Feature_data setFeature_dna_sequence(String feature_dna_sequence) {
    this.feature_dna_sequence = feature_dna_sequence;
    return this;
  }
  ...
  public Feature_data setFeature_md5(String feature_md5) {
    this.feature_md5 = feature_md5;
    return this;
  }
  ...
  public Feature_data setFeature_locations(List<Region> feature_locations) {
    this.feature_locations = feature_locations;
    return this;
  }
  ...
  public Feature_data setFeature_publications(List<String> feature_publications) {
    this.feature_publications = feature_publications;
    return this;
  }
  ...
  public Feature_data setFeature_quality_warnings(List<String> feature_quality_warnings) {
    this.feature_quality_warnings = feature_quality_warnings;
    return this;
  }
  ...
  public Feature_data setFeature_quality_score(List<String> feature_quality_score) {
    this.feature_quality_score = feature_quality_score;
    return this;
  }
  ...
  public Feature_data setFeature_notes(String feature_notes) {
    this.feature_notes = feature_notes;
    return this;
  }
  ...
  public Feature_data setFeature_inference(String feature_inference) {
    this.feature_inference = feature_inference;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof Feature_data)
      return this.equals((Feature_data)that);
    return false;
  }

  public boolean equals(Feature_data that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(Feature_data other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("Feature_data(");
    boolean first = true;
  ...
  private static class Feature_dataStandardSchemeFactory implements SchemeFactory {
    public Feature_dataStandardScheme getScheme() {
      return new Feature_dataStandardScheme();
    }
  }

  private static class Feature_dataStandardScheme extends StandardScheme<Feature_data> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, Feature_data struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 12: // FEATURE_NOTES
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.feature_notes = iprot.readString();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Feature_data struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.feature_aliases != null) {
        oprot.writeFieldBegin(FEATURE_ALIASES_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, List<String>> _iter161 : struct.feature_aliases.entrySet())
          {
      ...
      if (struct.feature_locations != null) {
        oprot.writeFieldBegin(FEATURE_LOCATIONS_FIELD_DESC);
        {
          ...
          for (Region _iter163 : struct.feature_locations)
          {
      ...
      if (struct.feature_publications != null) {
        oprot.writeFieldBegin(FEATURE_PUBLICATIONS_FIELD_DESC);
        {
          ...
          for (String _iter164 : struct.feature_publications)
          {
      ...
      if (struct.feature_quality_warnings != null) {
        oprot.writeFieldBegin(FEATURE_QUALITY_WARNINGS_FIELD_DESC);
        {
          ...
          for (String _iter165 : struct.feature_quality_warnings)
          {
      ...
      if (struct.feature_quality_score != null) {
        oprot.writeFieldBegin(FEATURE_QUALITY_SCORE_FIELD_DESC);
        {
          ...
          for (String _iter166 : struct.feature_quality_score)
          {
      ...
      if (struct.feature_notes != null) {
        ...
        oprot.writeString(struct.feature_notes);
        oprot.writeFieldEnd();
      }
  ...
  private static class Feature_dataTupleSchemeFactory implements SchemeFactory {
    public Feature_dataTupleScheme getScheme() {
      return new Feature_dataTupleScheme();
    }
  }

  private static class Feature_dataTupleScheme extends TupleScheme<Feature_data> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, Feature_data struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetFeature_aliases()) {
        {
          ...
          for (Map.Entry<String, List<String>> _iter167 : struct.feature_aliases.entrySet())
          {
      ...
      if (struct.isSetFeature_locations()) {
        {
          ...
          for (Region _iter169 : struct.feature_locations)
          {
      ...
      if (struct.isSetFeature_publications()) {
        {
          ...
          for (String _iter170 : struct.feature_publications)
          {
      ...
      if (struct.isSetFeature_quality_warnings()) {
        {
          ...
          for (String _iter171 : struct.feature_quality_warnings)
          {
      ...
      if (struct.isSetFeature_quality_score()) {
        {
          ...
          for (String _iter172 : struct.feature_quality_score)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, Feature_data struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          for (int _i176 = 0; _i176 < _map173.size; ++_i176)
          {
            _key174 = iprot.readString();
            {
              ...
              _val175 = new ArrayList<String>(_list177.size);
              String _elem178;
            ...
            struct.feature_aliases.put(_key174, _val175);
          }
        }
        struct.setFeature_aliasesIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.feature_locations = new ArrayList<Region>(_list180.size);
          Region _elem181;
          for (int _i182 = 0; _i182 < _list180.size; ++_i182)
          {
            _elem181 = new Region();
            _elem181.read(iprot);
            struct.feature_locations.add(_elem181);
          }
        }
        struct.setFeature_locationsIsSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.feature_publications = new ArrayList<String>(_list183.size);
          String _elem184;
          for (int _i185 = 0; _i185 < _list183.size; ++_i185)
          {
            _elem184 = iprot.readString();
            struct.feature_publications.add(_elem184);
          }
        }
        struct.setFeature_publicationsIsSet(true);
      }
      if (incoming.get(9)) {
        {
          ...
          struct.feature_quality_warnings = new ArrayList<String>(_list186.size);
          String _elem187;
          for (int _i188 = 0; _i188 < _list186.size; ++_i188)
          {
            _elem187 = iprot.readString();
            struct.feature_quality_warnings.add(_elem187);
          }
        }
        struct.setFeature_quality_warningsIsSet(true);
      }
      if (incoming.get(10)) {
        {
          ...
          struct.feature_quality_score = new ArrayList<String>(_list189.size);
          String _elem190;
          for (int _i191 = 0; _i191 < _list189.size; ++_i191)
          {
            _elem190 = iprot.readString();
            struct.feature_quality_score.add(_elem190);
          }
        }
        struct.setFeature_quality_scoreIsSet(true);
      }
