            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.method_parameters = new ArrayList<ByteBuffer>(_list10.size);
                ByteBuffer _elem11;
                for (int _i12 = 0; _i12 < _list10.size; ++_i12)
                {
                  _elem11 = iprot.readBinary();
                  struct.method_parameters.add(_elem11);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.input_object_references = new ArrayList<String>(_list13.size);
                String _elem14;
                for (int _i15 = 0; _i15 < _list13.size; ++_i15)
                {
                  _elem14 = iprot.readString();
                  struct.input_object_references.add(_elem14);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.validated_object_references = new ArrayList<String>(_list16.size);
                String _elem17;
                for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                {
                  _elem17 = iprot.readString();
                  struct.validated_object_references.add(_elem17);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.intermediate_input_ids = new ArrayList<String>(_list19.size);
                String _elem20;
                for (int _i21 = 0; _i21 < _list19.size; ++_i21)
                {
                  _elem20 = iprot.readString();
                  struct.intermediate_input_ids.add(_elem20);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.intermediate_output_ids = new ArrayList<String>(_list22.size);
                String _elem23;
                for (int _i24 = 0; _i24 < _list22.size; ++_i24)
                {
                  _elem23 = iprot.readString();
                  struct.intermediate_output_ids.add(_elem23);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.external_data = new ArrayList<ExternalDataUnit>(_list25.size);
                ExternalDataUnit _elem26;
                for (int _i27 = 0; _i27 < _list25.size; ++_i27)
                {
                  _elem26 = new ExternalDataUnit();
                  _elem26.read(iprot);
                  struct.external_data.add(_elem26);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ObjectProvenanceAction struct) throws org.apache.thrift.TException {
      ...
      if (struct.method_parameters != null) {
        oprot.writeFieldBegin(METHOD_PARAMETERS_FIELD_DESC);
        {
          ...
          for (ByteBuffer _iter28 : struct.method_parameters)
          {
      ...
      if (struct.input_object_references != null) {
        oprot.writeFieldBegin(INPUT_OBJECT_REFERENCES_FIELD_DESC);
        {
          ...
          for (String _iter29 : struct.input_object_references)
          {
      ...
      if (struct.validated_object_references != null) {
        oprot.writeFieldBegin(VALIDATED_OBJECT_REFERENCES_FIELD_DESC);
        {
          ...
          for (String _iter30 : struct.validated_object_references)
          {
      ...
      if (struct.intermediate_input_ids != null) {
        oprot.writeFieldBegin(INTERMEDIATE_INPUT_IDS_FIELD_DESC);
        {
          ...
          for (String _iter31 : struct.intermediate_input_ids)
          {
      ...
      if (struct.intermediate_output_ids != null) {
        oprot.writeFieldBegin(INTERMEDIATE_OUTPUT_IDS_FIELD_DESC);
        {
          ...
          for (String _iter32 : struct.intermediate_output_ids)
          {
      ...
      if (struct.external_data != null) {
        oprot.writeFieldBegin(EXTERNAL_DATA_FIELD_DESC);
        {
          ...
          for (ExternalDataUnit _iter33 : struct.external_data)
          {
            _iter33.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetMethod_parameters()) {
        {
          ...
          for (ByteBuffer _iter34 : struct.method_parameters)
          {
      ...
      if (struct.isSetInput_object_references()) {
        {
          ...
          for (String _iter35 : struct.input_object_references)
          {
      ...
      if (struct.isSetValidated_object_references()) {
        {
          ...
          for (String _iter36 : struct.validated_object_references)
          {
      ...
      if (struct.isSetIntermediate_input_ids()) {
        {
          ...
          for (String _iter37 : struct.intermediate_input_ids)
          {
      ...
      if (struct.isSetIntermediate_output_ids()) {
        {
          ...
          for (String _iter38 : struct.intermediate_output_ids)
          {
      ...
      if (struct.isSetExternal_data()) {
        {
          ...
          for (ExternalDataUnit _iter39 : struct.external_data)
          {
            _iter39.write(oprot);
          }
        }
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.method_parameters = new ArrayList<ByteBuffer>(_list40.size);
          ByteBuffer _elem41;
          for (int _i42 = 0; _i42 < _list40.size; ++_i42)
          {
            _elem41 = iprot.readBinary();
            struct.method_parameters.add(_elem41);
          }
        }
        struct.setMethod_parametersIsSet(true);
      }
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.input_object_references = new ArrayList<String>(_list43.size);
          String _elem44;
          for (int _i45 = 0; _i45 < _list43.size; ++_i45)
          {
            _elem44 = iprot.readString();
            struct.input_object_references.add(_elem44);
          }
        }
        struct.setInput_object_referencesIsSet(true);
      }
      if (incoming.get(9)) {
        {
          ...
          struct.validated_object_references = new ArrayList<String>(_list46.size);
          String _elem47;
          for (int _i48 = 0; _i48 < _list46.size; ++_i48)
          {
            _elem47 = iprot.readString();
            struct.validated_object_references.add(_elem47);
          }
        }
        struct.setValidated_object_referencesIsSet(true);
      }
      if (incoming.get(10)) {
        {
          ...
          struct.intermediate_input_ids = new ArrayList<String>(_list49.size);
          String _elem50;
          for (int _i51 = 0; _i51 < _list49.size; ++_i51)
          {
            _elem50 = iprot.readString();
            struct.intermediate_input_ids.add(_elem50);
          }
        }
        struct.setIntermediate_input_idsIsSet(true);
      }
      if (incoming.get(11)) {
        {
          ...
          struct.intermediate_output_ids = new ArrayList<String>(_list52.size);
          String _elem53;
          for (int _i54 = 0; _i54 < _list52.size; ++_i54)
          {
            _elem53 = iprot.readString();
            struct.intermediate_output_ids.add(_elem53);
          }
        }
        struct.setIntermediate_output_idsIsSet(true);
      }
      if (incoming.get(12)) {
        {
          ...
          struct.external_data = new ArrayList<ExternalDataUnit>(_list55.size);
          ExternalDataUnit _elem56;
          for (int _i57 = 0; _i57 < _list55.size; ++_i57)
          {
            _elem56 = new ExternalDataUnit();
            _elem56.read(iprot);
            struct.external_data.add(_elem56);
          }
        }
        struct.setExternal_dataIsSet(true);
      }
