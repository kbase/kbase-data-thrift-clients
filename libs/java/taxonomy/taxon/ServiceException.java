            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i61 = 0; _i61 < _map58.size; ++_i61)
                {
                  ...
                  struct.inputs.put(_key59, _val60);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.inputs != null) {
        if (struct.isSetInputs()) {
          oprot.writeFieldBegin(INPUTS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter62 : struct.inputs.entrySet())
            {
      ...
      if (struct.isSetInputs()) {
        {
          ...
          for (Map.Entry<String, String> _iter63 : struct.inputs.entrySet())
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          for (int _i67 = 0; _i67 < _map64.size; ++_i67)
          {
            ...
            struct.inputs.put(_key65, _val66);
          }
        }
        struct.setInputsIsSet(true);
      }
